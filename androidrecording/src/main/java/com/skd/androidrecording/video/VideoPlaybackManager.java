...
public class VideoPlaybackManager implements SurfaceHolder.Callback, OnPreparedListener,
    ...
    public VideoPlaybackManager(Context ctx, AdaptiveSurfaceView videoView, PlaybackHandler
			playbackHandler) {

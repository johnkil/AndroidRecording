...
public class VideoRecordingManager implements SurfaceHolder.Callback {
    ...
    public VideoRecordingManager(AdaptiveSurfaceView videoView, VideoRecordingHandler
            recordingHandler) {
    ...
    public boolean startRecording(String fileName, Size videoSize) {
        ...
        return recorderManager.startRecording(cameraManager.getCamera(), fileName, videoSize,
                degree);
    }

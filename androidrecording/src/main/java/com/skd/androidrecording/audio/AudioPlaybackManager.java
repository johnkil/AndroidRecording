...
public class AudioPlaybackManager implements OnGlobalLayoutListener, OnPreparedListener,
        MediaPlayerControl, OnCompletionListener {
    ...
    public AudioPlaybackManager(Context ctx, VisualizerView visualizerView, PlaybackHandler
            playbackHandler) {

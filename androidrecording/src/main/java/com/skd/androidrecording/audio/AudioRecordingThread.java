...
public class AudioRecordingThread extends Thread {
    ...
    private void proceed() {
        ...
        /*
         * See http://developer.android.com/reference/android/media/audiofx/Visualizer
    ...
    private void convertRawToWav() {
        ...
        try {
            PcmAudioHelper.convertRawToWav(WavAudioFormat.mono16Bit(SAMPLING_RATE), file_raw,
                    file_wav);
            file_raw.delete();
            if (handler != null) {

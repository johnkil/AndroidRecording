...
import com.skd.androidrecording.sample.util.NotificationUtils;
import com.skd.androidrecording.sample.util.StorageUtils;
...
public class VideoRecordingActivity extends AppCompatActivity {
    ...
    private void initVideoSizeSpinner() {
        ...
        if (Build.VERSION.SDK_INT >= 11) {
            List<Size> sizes = CameraHelper.getCameraSupportedVideoSizes(recordingManager
    ...
    private void updateVideoSizes() {
        if (Build.VERSION.SDK_INT >= 11) {
            ((SizeAdapter) videoSizeSpinner.getAdapter()).set(CameraHelper
                    .getCameraSupportedVideoSizes(recordingManager.getCameraManager().getCamera
                            ()));
